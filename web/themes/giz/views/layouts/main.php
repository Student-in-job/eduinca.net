	...
	<header id="navtop">
		...
		<?php $this->widget('zii.widgets.CMenu',array(
			...
			'items'=>array(
                            ...
                            array('label' => Yii::t('site','survey'), 'url' => array('/survey/index'), 'visible' => (Yii::app()->user->name == 'administrator')),
                            array('label' => Yii::t('site','statistics'), 'url' => array('/statistics/index'), 'visible' => (Yii::app()->user->name == 'administrator')),
                            array('label' => Yii::t('site','reports'), 'url' => array('/analytic/index'), 'visible' => (Yii::app()->user->name == 'administrator')),
                            array('label' => Yii::t('site','editor'), 'url' => array('/editor/index'), 'visible' => (Yii::app()->user->name == 'administrator')),
                            array('label' => Yii::t('site','settings'), 'url' => array('/settings/index'), 'visible' => (Yii::app()->user->name == 'administrator')),
