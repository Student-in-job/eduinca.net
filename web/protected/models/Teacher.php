...
class Teacher extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'sex' => Yii::t('answerteacher','sex'),
                        'year' => Yii::t('answerteacher','year'),
			'faculty' => Yii::t('answerteacher','faculty'),
			...
			'common_q1' => Yii::t('answerteacher','common_q1'),
			'common_q2' => Yii::t('answerteacher','common_q2'),
			'common_q3' => Yii::t('answerteacher','common_q3'),
			'common_q4' => Yii::t('answerteacher','common_q4'),
			'common_q5' => Yii::t('answerteacher','common_q5'),
			'common_q6' => Yii::t('answerteacher','common_q6'),
			'common_q7' => Yii::t('answerteacher','common_q7'),
			'common_q8' => Yii::t('answerteacher','common_q8'),
			'common_q9' => Yii::t('answerteacher','common_q9'),
			'common_comment' => Yii::t('answerteacher','common_comment'),
			'methodic_q1' => Yii::t('answerteacher','methodic_q1'),
			'methodic_q2' => Yii::t('answerteacher','methodic_q2'),
			'methodic_q3' => Yii::t('answerteacher','methodic_q3'),
			'methodic_q4' => Yii::t('answerteacher','methodic_q4'),
			'methodic_q5' => Yii::t('answerteacher','methodic_q5'),
			'methodic_q6' => Yii::t('answerteacher','methodic_q6'),
			'methodic_q7' => Yii::t('answerteacher','methodic_q7'),
			'methodic_q8' => Yii::t('answerteacher','methodic_q8'),
			'methodic_q9' => Yii::t('answerteacher','methodic_q9'),
			'methodic_q10' => Yii::t('answerteacher','methodic_q10'),
			'methodic_q11' => Yii::t('answerteacher','methodic_q11'),
			'methodic_q12' => Yii::t('answerteacher','methodic_q12'),
			'methodic_q13' => Yii::t('answerteacher','methodic_q13'),
			'methodic_comment' => Yii::t('answerteacher','methodic_comment'),
			'labs' => Yii::t('answerteacher','labs'),
			'num_labs' => Yii::t('answerteacher','num_labs'),
			'labs_comment' => Yii::t('answerteacher','labs_comment'),
			'practice' => Yii::t('answerteacher','practice'),
			'practice_place' => Yii::t('answerteacher','practice_place'),
			'practice_duration' => Yii::t('answerteacher','practice_duration'),
			'num_of_papers' => Yii::t('answerteacher','num_of_papers'),
			...
			'private_papers' => Yii::t('answerteacher','private_papers'),
			'private_comments' =>Yii::t('answerteacher','private_comments'),
