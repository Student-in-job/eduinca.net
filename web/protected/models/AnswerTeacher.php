...
class AnswerTeacher extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_answer', 'required'),
			array('id_answer, age, sex, student_teach, common_q1, common_q2, common_q3, common_q4, common_q5, common_q6, common_q7, common_q8, common_q9, methodic_q1, methodic_q2, methodic_q3, methodic_q4, methodic_q5, methodic_q6, methodic_q7, methodic_q8, methodic_q9, methodic_q10, methodic_q11, methodic_q12, methodic_q13, labs, num_labs, practice, practice_place, practice_duration, num_of_papers, num_of_papers_theoretical, num_of_papers_practical, private_papers, university_id, person_type_id, involved_person_id', 'numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
		return array(
			...
			'student_teach' => Yii::t('answerteacher','studentteach'),
			...
			'num_of_papers_theoretical' => Yii::t('answerteacher','num_of_papers_theoretical1'),
	...
	public function search()
	{
		...
		$criteria->compare('student_teach',$this->student_teach);
