...
?>
	...
	<?php echo $form->dropDownList($model,'language', $languages, array('style' => 'width:auto')); ?>
    </div>
    <br/>
    <div class="row buttons">
        <?php
            echo CHtml::submitButton(Yii::t('reports','next') . ' →', array(
                    'submit' => array('generate', 'id' => $id),
                    'style' => 'width:auto',
            ));
        ?>
    </div>
...
<!--
<div>
    <div class="circle active first">Выбор языка</div>
    <div class="circle passive second">Подготовка данных</div>
