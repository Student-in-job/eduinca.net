	...
	<div class="row">
        ...
        <div class='row'>
         ...
         <table class='table-bordered'>
            <thead>
                <tr>
                    <td style="width: 500px;padding: 15px;"><b><?php echo Yii::t('answerteacher','methodic_teach');?></b></td>
                    <td style="width: 300px;padding: 15px;">
                        <?php echo Yii::t('answerteacher','methodic_answers1');?>
                    </td>
                    <td style="width: 300px;padding: 15px;">
                        <?php echo Yii::t('answerteacher','methodic_answers2');?>
                    </td>
                </tr>
            </thead>
            <tbody>
