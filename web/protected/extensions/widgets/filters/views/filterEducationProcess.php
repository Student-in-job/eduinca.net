...
<div class="titledropmenu">	
    ...
    <table>
        ...
        <tr>
            <td>
                <?php echo CHtml::label(Yii::t('analytic', 'teachers'), 'questions_teachers');?>
                <?php echo $form->checkBoxList($this->model, 'questions_teachers', $this->questions_teachers);?>
            </td>
            <td>
                <?php echo CHtml::label(Yii::t('analytic', 'students'), 'questions_students');?>
                <?php echo $form->checkBoxList($this->model, 'questions_students', $this->questions_students);?>
            </td>
        </tr>
        <tr>
            <td colspan="2">
